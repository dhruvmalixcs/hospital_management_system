...
public class HospitalManagementSystem {
    ...
    private static final String password="Dmalik@001020";
    ...
    public static void bookAppointment(Patient patient, Doctor doctor, Connection connection, Scanner scanner) {
        ...
        if (patient.checkPatient(patientId) && doctor.checkDoctorsByID(doctorId)) {
    ...
    public static boolean checkDoctorAvailability(int doctorId ,String appointmentsDate, Connection connection){
